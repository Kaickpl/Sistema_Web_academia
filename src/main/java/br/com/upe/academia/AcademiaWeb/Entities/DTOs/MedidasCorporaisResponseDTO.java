...
public class MedidasCorporaisResponseDTO {
    ...
    public MedidasCorporaisResponseDTO(MedidasCorporais medidasCorporais) {
        this.medidasCoporaisId = medidasCorporais.getIdMedidas();
        this.data = medidasCorporais.getData();
